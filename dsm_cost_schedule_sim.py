...
class SimulatorGUI:
    ...
    def _all_task_labels(self, n: int) -> List[str]:
        return [self._task_label(i) for i in range(n)]

    def _update_column_headers(self) -> None:
        labels = self._all_task_labels(len(self.col_header_labels))
    ...
    def _rebuild_tables(self) -> None:
        ...
        for c in range(n):
            lbl = ttk.Label(grid, text=self._task_label(c), width=8, anchor="center")
