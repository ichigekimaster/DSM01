...
class SimulatorGUI:
    ...
    def _rebuild_tables(self) -> None:
        ...
        canvas = tk.Canvas(self.dsm_frame, borderwidth=0)
        vscroll = ttk.Scrollbar(self.dsm_frame, orient="vertical", command=canvas.yview)
        hscroll = ttk.Scrollbar(self.dsm_frame, orient="horizontal", command=canvas.xview)
